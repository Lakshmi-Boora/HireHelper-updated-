...
const SendRequestForm = ({ taskId, taskTitle, isOpen, onClose, onSuccess }) => {
      ...
      <div className="bg-white rounded-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-4">
          ...
          <div className="mb-4">
            ...
            <textarea id="description" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Describe why you're a good fit for this task, your relevant experience, and when you're available..." rows={6} required className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"/>
          </div>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button type="submit" disabled={loading || !description.trim()} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-medium">
